<template>
  <div>
    <v-container class="v-container-sm">
      <h1 class="pt-6" align="center">Hello! {魏麗莎}，請填寫購買資訊</h1>
      <div align="center" class="pt-6 grey--text">
        您已經是 {BookFast} 會員，付款完成後，購買紀錄將存至您的帳號
        {0922345678}。<br />
      ...
      <div class="my-6">
        <v-container class="fill-height">
          <v-row class="v-card-border" align="center">
            ...
            <v-col cols="12" sm="12" class="px-6">
              <div class="my-1 grey--text">扣款額度及票券</div>
              <div>{350 元/小班定期團課 套票 1 堂}</div>
            </v-col>
          </v-row>
        </v-container>
      </div>
