    ...
    <v-row>
      <v-col cols="12" sm="3">
        ...
        >
          <div class="text-center">
            ...
            <h3>魏麗莎</h3>
            <span class="caption grey--text text--darken-1">0922 345 678</span>
          </div>
          <!--  -->
      ...
      <v-col cols="12" sm="9">
        <v-sheet min-height="70vh" rounded="lg" class="alpha">
          <!--  -->
          <div class="large-title pb-4">預約記錄</div>
          <v-tabs class="alpha">
            <v-tab>
              <b class="black--text">即將到來</b>
              <span class="grey--text caption font-weight-bold">(3)</span>
            </v-tab>

            <v-tab>
              <b class="black--text">已結束</b>
              <span class="grey--text caption font-weight-bold">(26)</span>
            </v-tab>

            <v-tab>
              <b class="black--text">空值</b>
              <span class="grey--text caption font-weight-bold">(0)</span>
            </v-tab>

            <v-tab-item>
              <MemberCome></MemberCome
              ><!-- 引入的內容 -->
            </v-tab-item>
...
<script>
import MemberCome from "./member/member_come.vue";
import MemberEnd from "./member/member_end.vue";
import MemberEmpty from "./member/member_empty.vue";
